...
# TODO
# HTML parsing is evil
# Change all rake tasks that do not parse data from webservice or xml
namespace :spree_multi_currency do
  namespace :currency do
    desc 'National Classification rates (abbreviated OKW)'
    ...
    desc 'Rates from Central Bank of Russian Federation'
  ...
  namespace :rates do
    desc 'Rates from the Savings Bank of the Russian Federation'
